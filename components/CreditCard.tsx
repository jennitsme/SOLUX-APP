    ...
    <div className="flex flex-col gap-6 select-none">
      ...
      >
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20">
           <span className="bg-black/5 text-[8px] font-black px-3 py-1 rounded-full text-black/40 uppercase tracking-[0.3em] backdrop-blur-sm border border-black/5">Sandbox Mode</span>
        </div>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
          <div className="flex justify-between items-start">
            ...
            <div className="text-right">
               ...
               <span className="text-[7px] uppercase tracking-[0.4em] text-slate-400 font-bold block mt-1">TEST CARD</span>
            </div>
          </div>
      ...
      <div className="flex items-center justify-between border border-gray-100 p-4 rounded-2xl bg-white shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[8px] text-slate-400 font-bold tracking-tight uppercase">Lithic Simulation Layer</span>
          </div>
        </div>
        <button 
          onClick={(e) => {
